  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center px-4">
      <div className="max-w-3xl">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-500 dark:from-yellow-300 dark:to-orange-400 p-4">
          {displayedName}
          <span className={`inline-block w-1 h-10 ${
...
<div className="mt-10 flex items-center justify-center gap-6">
  ...
  <a
    ...
    className="transition-transform rounded-full hover:scale-120 ${theme === 'dark' ? bg-white : ''}"
  >
